    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (instrucionMemoria[0]) {
                ...
                case "str":
                	  try {
                          System.out.print("que opcion de str desea usar\n1)str rd, [rb]\n2)str rd, [rb,#offset5]\n3)str rd, [rb,r0]");
                          condicionSalir = teclado.nextLine();

                         if (Integer.parseInt(condicionSalir) == 1) {
                          System.out.print("Ingrese el numero del registro que contiene el valor a almacenar ");
                          instrucionMemoria[1] = teclado.nextLine();
                          numeroRegistroUsar = Integer.parseInt(instrucionMemoria[1]);
                          System.out.print("Ingrese el numero registro que contiene  la direcion en memoria");                 
                          instrucionMemoria[2] = teclado.nextLine();
                          numeroRegistroUsar1 = Integer.parseInt(instrucionMemoria[2]);
                          System.out.print("Instruciona ejecutar :" + instrucionMemoria[0] + " registro"
                          + instrucionMemoria[1] + ",[registro" + instrucionMemoria[2] + "]\n");
                          ...
                          instrucionMemoria[2] = teclado.nextLine();
                          numeroRegistroUsar1 = Integer.parseInt(instrucionMemoria[2]);
                          System.out.print("Ingrese el numero offset5 a desplazar");                 
                          instrucionMemoria[3] = teclado.nextLine();
                          DecimalConvertirCarga = Integer.parseInt(instrucionMemoria[3]); 
                            
                             System.out.print("Instruciona ejecutar :" + instrucionMemoria[0] + " registro" 
                             + instrucionMemoria[1] + ",[registro" + instrucionMemoria[2] + ","+ instrucionMemoria[3]+"]\n");
                              memoryDump[numeroRegistroUsar1+DecimalConvertirCarga] = registros[numeroRegistroUsar];
             
                                                         
                         }if(Integer.parseInt(condicionSalir)==3){
                          System.out.print("Ingrese el numero de registro en el que va a almacenar");
                          instrucionMemoria[1] = teclado.nextLine();
                          numeroRegistroUsar = Integer.parseInt(instrucionMemoria[1]);
                          System.out.print("Ingrese el registro al que desea apuntar");                 
                          instrucionMemoria[2] = teclado.nextLine();
                          numeroRegistroUsar1 = Integer.parseInt(instrucionMemoria[2]);
                          System.out.print("Ingrese el registro al que contiene el numero a desplazar");                 
                          instrucionMemoria[3] = teclado.nextLine();
                          numeroRegistroUsar2 = Integer.parseInt(instrucionMemoria[3]);                         
                          System.out.print("Instruciona ejecutar :" + instrucionMemoria[0] + " registro" 
                                  + instrucionMemoria[1] + ",[registro" + instrucionMemoria[2] + ",registro"+ instrucionMemoria[3]+"]\n");                         
                          numeroRegistroUsar2 =Integer.parseInt(registros[numeroRegistroUsar2]);                       
                          memoryDump[numeroRegistroUsar1 +numeroRegistroUsar2] =registros[numeroRegistroUsar ];
                        ...
                        case "sub":
                            try {
                               System.out.print(" Realizar operacion SUB con\nsubA: 2 Operandos\nsubB: 3 Operandos\n");
                                ...
                                case "subA" :
                                    System.out.print("Ingrese el numero de registro al que se va a cargar ");
                                    instrucionMemoria[1] = teclado.nextLine();
                                    numeroRegistroUsar = Integer.parseInt(instrucionMemoria[1]);
                                    System.out.print("Ingrese el numero del primer registro");
                                    instrucionMemoria[2] = teclado.nextLine();
                                    numeroRegistroUsar1 = Integer.parseInt(instrucionMemoria[2]);
                                    System.out.print("Ingrese el numero del segundo registro  ");
                                    instrucionMemoria[3] = teclado.nextLine();
                                    numeroRegistroUsar2 = Integer.parseInt(instrucionMemoria[3]);

                                    System.out.print("Instruciona ejecutar :" + instrucionMemoria[0] + " registro" + instrucionMemoria[1] + ",registro" + instrucionMemoria[2] + "\n");
                                    registros[numeroRegistroUsar]= InstruccionesAritmeticas.operacionSub2(registros[numeroRegistroUsar1], registros[numeroRegistroUsar2]);
                                break;
                                case "subB" :
                                    System.out.print("Ingrese el numero de registro al que se va carga y tiene el valor a usar ");
                                    instrucionMemoria[1] = teclado.nextLine();
