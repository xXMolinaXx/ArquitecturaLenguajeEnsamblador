                ...
                case "str":
                	  try {
                         ...
                         if (Integer.parseInt(condicionSalir) == 1) {
                          ...
                          instrucionMemoria[1] = teclado.nextLine();
                          numeroRegistroUsar = Integer.parseInt(instrucionMemoria[1]);
                          System.out.print("Ingrese el numero registro que contiene el valor a almacenar");                 
                          instrucionMemoria[2] = teclado.nextLine();
                          numeroRegistroUsar1 = Integer.parseInt(instrucionMemoria[2]);
                          System.out.print("Instruciona ejecutar :" + instrucionMemoria[0] + " registro"
                          + instrucionMemoria[1] + ",[registro" + instrucionMemoria[2] + "]\n");
                          memoryDump[numeroRegistroUsar] = registros[numeroRegistroUsar1];
                          ...
                          DecimalConvertirCarga = Integer.parseInt(instrucionMemoria[3]); 
                             ...
                             + instrucionMemoria[1] + ",[registro" + instrucionMemoria[2] + ","+ instrucionMemoria[3]+"]\n");
                              memoryDump[numeroRegistroUsar] = registros[numeroRegistroUsar1+DecimalConvertirCarga];
                             }else {System.out.print("Numero demasiado grande");}
                          ...
                          memoryDump[numeroRegistroUsar] =registros[numeroRegistroUsar1 +numeroRegistroUsar2 ];
